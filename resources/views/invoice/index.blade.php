            ...
            <hr />
                <div class="panel panel-default">
                    <div style="margin:7px">
                        ...
                        <div class="col-xs-2">
                            <div class="btn-group">
                                <a href="{{ url('orders/proceso/3') }}" class="btn btn"><span><i class="fa fa-plus-circle" aria-hidden="true"></i> Ordenes En proceso</span></a>

                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="btn-group">
                                <a href="{{ url('orders/entrada/1') }}" class="btn btn"><span><i class="fa fa-plus-circle" aria-hidden="true"></i> Ordenes de Entrada</span></a>

                            </div>
                        </div>
                        <div class="col-xs-2">
                            <div class="btn-group">
                                <a href="{{ url('orders/salida/2') }}" class="btn btn"><span><i class="fa fa-plus-circle" aria-hidden="true"></i> Ordenes de Salida</span></a>
                    ...
                    <div class="panel-body" style="padding:0px">
                        <table class="table table-striped table-bordered" style="margin:0px">
                            <thead>
                            <tr>
                                <th style="width:300px;">Proveedor o Paciente</th>
                                <th style="width:80px;" class="">No. Orden</th>
                                <th style="width:100px;" class="">Tipo Orden</th>
                                <th style="width:150px;" class="">Estatus</th>
                                <th style="width:300px;" class="">Creado</th>
                            ...
                            @foreach ($order as $m)
                                <tr>
                                    ...
                                    @endif
                                    <td class="">{{ $m->statu->statu  }}</td>
                                    <td class="">{{ $m->created_at  }}</td>
                                    <td style="width:180px;" >
                                        @if($m->statu->statu = "EN PROCESO")
                                            <a class="btn btn-success btn-block btn-xs" href="{{ url('order/entregar/' . $m->id) }}">
                                                <i class="fa "></i> Entregar Orden
                                            </a>
                                        @else
