                ...
                <div class="row panel panel">
                    ...
                    <div class="col-md-8 col-xs-12 col-sm-6 col-lg-8">
                        ...
                        <ul class="container details">
                            ...
                            <li><p><span class="glyphicon glyphicon-map-marker one" style="width:50px;"></span>{{$people->addresses->street}} N° CASA {{$people->addresses->N°_house}}, SECTOR {{$people->addresses->sector->sector}}, PARROQUIA
