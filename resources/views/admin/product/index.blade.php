        ...
        <div class="row" style="margin:20px">
            <div class="col-lg-10">
                ...
                @if(!isset($classification))
                    <strom><i class="fa fa-list-alt fa-3x" aria-hidden="true"> Lista de Productos </i> </strom>
                @else 
                    <strom><i class="fa fa-list-alt fa-3x" aria-hidden="true"> Lista de {{ ucfirst(strtolower($classification)) }}</i> </strom>
                @endif
                <hr />
