...
Route::group(['middleware' => 'auth'], function(){
   ...
   // Route::resource('admin/people', 'Admin\\PeopleController', ['only' => ['index', 'show', 'create', 'store']]);
    ...
    Route::get('/order/saveOut', 'Admin\\OrderController@orderSaveOut');

    Route::get('orders/proceso/{statu_id}', 'Admin\\OrderController@index2');
    Route::get('orders/entrada/{type_order_id}', 'Admin\\OrderController@index2');
    Route::get('orders/salida/{type_order_id}', 'Admin\\OrderController@index2');

    Route::get('order/entregar/{id}', 'Admin\\OrderController@entregar');
    ...
    Route::group(['middleware' => 'role'], function() {
        ...
        //Ruta que devuelve los productos dependiendo del tipo
        Route::get('admin/product/type/{id}', [
            'as' => 'product.type',
            'uses' => 'Admin\\ClassificationController@productByType'
        ]);
